...
const App: () => React$Node = () => {
  const triggerAsyncFunctionException = async () => {
    bogusHandledFunction(); // eslint-disable-line no-undef
  };
  return (
    <>
        ...
        <ScrollView
          ...
          <View style={styles.container}>
            <Text
              ...
              Press the buttons below to test examples of Bugsnag functionality.
              Make sure you have changed the API key in Info.plist or
              AndroidManifest.xml.
            </Text>
            <ScrollView>
              <View style={styles.buttonContainer}>
                ...
                <Button
                  color="red"
                  title="Trigger Async JS Exception"
                  onPress={triggerAsyncFunctionException}
                />
                <Text style={styles.info}>
                  Tap this button to send a JS crash to Bugsnag in async
                  function
                </Text>
                ...
                />
                <Text style={styles.info}>
                  Tap this button to send a native {Platform.OS} crash to
                  Bugsnag
                </Text>
                ...
                />
                <Text style={styles.info}>
                  Tap this button to send a handled error with user information
                  to Bugsnag
                </Text>
                ...
                />
                <Text style={styles.info}>
                  Tap this button to send a handled error with manual
                  breadcrumbs
                </Text>
              </View>
            </ScrollView>
